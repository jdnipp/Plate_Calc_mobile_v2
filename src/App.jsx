      ...
      <div className={`barbell-fit ${dense ? "dense" : ""}`}>
        <div className="plate-side">
          {left.map((plate, index) => (
            <div key={`left-${plate}-${index}`} className="plate" style={{ height: `${plateHeight(plate)}px` }} title={`${formatNumber(plate)} ${unitLabel}`}>
        ...
        <div className="plate-side">
          ...
          {right.map((plate, index) => (
            <div key={`right-${plate}-${index}`} className="plate" style={{ height: `${plateHeight(plate)}px` }} title={`${formatNumber(plate)} ${unitLabel}`}>
              <span>{formatNumber(plate)}</span>
            </div>
          ))}
        </div>
